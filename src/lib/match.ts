...
const relatedSkills: Record<string, string[]> = {
  ...
  api: ["api", "api-integration", "node"],
  "api-integration": ["api-integration", "api", "zapier", "n8n", "make", "webhook"],
  zapier: ["zapier", "api-integration", "api"],
  n8n: ["n8n", "api-integration", "api"],
  make: ["make", "api-integration", "api"],
  webhook: ["webhook", "api", "api-integration"],
