export const categories = [
  ...
  { slug: "workflow-automation", label: "Workflow automation", group: "Workflow" },
  ...
  { slug: "claude-api", label: "Claude API", group: "AI automation & agents" },
  { slug: "claude-cowork", label: "Claude Cowork", group: "AI automation & agents" },
  { slug: "prompt-engineering", label: "Prompt engineering", group: "AI automation & agents" },
